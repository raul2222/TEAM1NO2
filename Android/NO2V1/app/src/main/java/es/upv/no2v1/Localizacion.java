...
public class Localizacion implements LocationListener {
    ...
    public Localizacion(int tiempo, int distancia, Activity main, Medicion med) {
        ...
        //se obliga a que el valor tiempo sea 11 segundos
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 11*1000, distancia, (LocationListener) this);
    }
